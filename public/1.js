...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios.get('/api/script/getFavoriteScripts');

            case 2:
              _yield$axios$get = _context.sent;
              data = _yield$axios$get.data;
              _this.favoriteScripts = data;
  ...
  methods: {
     ...
     * @param script
     */
    switchOnScript: function switchOnScript(script) {
      this.$emit('selectNextScript', script);
      this.favoriteScripts = this.favoriteScripts.filter(function (el) {
        return el.id != script.id;
      });
    }
  }
});
...
/* harmony import */ var _components_RunScript_favorites_scripts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../components/RunScript/favorites_scripts */ "./resources/js/components/RunScript/favorites_scripts.vue");
/* harmony import */ var _components_RunScript_selectAnswer_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../components/RunScript/selectAnswer.vue */ "./resources/js/components/RunScript/selectAnswer.vue");
/* harmony import */ var _functions_getStuffById__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../functions/getStuffById */ "./resources/js/functions/getStuffById.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    SelectAnswer: _components_RunScript_selectAnswer_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
    FavoritesScripts: _components_RunScript_favorites_scripts__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      questions: [],
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])(['setCurrentScriptId'])), {}, {
     ...
     */
    selectNextScript: function selectNextScript(script) {
      var _this2 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        var _yield$_this2$getFirs, data;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this2.getFirstQuestion(script.id);

              case 2:
                _yield$_this2$getFirs = _context2.sent;
                data = _yield$_this2$getFirs.data;

                if (data.length) {
                  _this2.questions.push(data[0]);

                  _this2.answers.push({
                    name: 'Переключение на скрипт с именем "' + script.name + '"'
                  });

                  _this2.currentQuestionId = data[0].id;

                  _this2.$store.dispatch('setCurrentScriptId', data[0].id);
                } else {
                  alert('В редактировании скрипта не указан начальный вопрос');
                }
    ...
    isPrepareDialogResultData: function isPrepareDialogResultData(_ref) {
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
        var questions, answers, _yield$axios$post, status;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_6___default.a.post('/api/RunningScript/saveSequence', {
                  questions: questions,
                  answers: answers
                });
    ...
    getFirstQuestion: function getFirstQuestion() {
      return axios__WEBPACK_IMPORTED_MODULE_6___default.a.get('/api/question/getFirstQuestion/?scriptId=' + this.currentScriptId);
    },
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return Object(_functions_getStuffById__WEBPACK_IMPORTED_MODULE_5__["getAnswerById"])(id);

              case 2:
                _yield$getAnswerById = _context4.sent;
                data = _yield$getAnswerById.data;

                _this3.answers.push(data);
                ...
                _context4.next = 8;
                return Object(_functions_getStuffById__WEBPACK_IMPORTED_MODULE_5__["getQuestionById"])(data.next_question_id);

              case 8:
                nextQuestion = _context4.sent;
                _this3.currentQuestionId = nextQuestion.data.id;

                _this3.questions.push(nextQuestion.data);
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=style&index=0&lang=css&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--5-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--5-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=style&index=0&lang=css& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=style&index=0&lang=css&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--5-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--5-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../../node_modules/css-loader??ref--5-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--5-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./favorites_scripts.vue?vue&type=style&index=0&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=style&index=0&lang=css&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=template&id=58d1bdec&":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=template&id=58d1bdec& ***!
  \******************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "favorites_scripts" }, [
    _vm.favoriteScripts.length
      ? _c(
          "div",
          [
            _c("h3", [
            ...
            _vm._v(" "),
            _vm._l(_vm.favoriteScripts, function(script) {
              return _c("div", { key: script.id }, [
                _c(
                  "span",
                  {
                    staticClass: "favorite_script_item",
                    on: {
                      click: function($event) {
                        return _vm.switchOnScript(script)
                      }
                    }
                  },
                  [
  ...
  return _c(
    ...
    [
      ...
      _vm.startScript
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("favorites-scripts", {
        on: { selectNextScript: _vm.selectNextScript }
      })
    ],
    1
  )
...
/***/ "./resources/js/components/RunScript/favorites_scripts.vue":
/*!*****************************************************************!*\
  !*** ./resources/js/components/RunScript/favorites_scripts.vue ***!
  \*****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _favorites_scripts_vue_vue_type_template_id_58d1bdec___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./favorites_scripts.vue?vue&type=template&id=58d1bdec& */ "./resources/js/components/RunScript/favorites_scripts.vue?vue&type=template&id=58d1bdec&");
/* harmony import */ var _favorites_scripts_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./favorites_scripts.vue?vue&type=script&lang=js& */ "./resources/js/components/RunScript/favorites_scripts.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _favorites_scripts_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./favorites_scripts.vue?vue&type=style&index=0&lang=css& */ "./resources/js/components/RunScript/favorites_scripts.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _favorites_scripts_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _favorites_scripts_vue_vue_type_template_id_58d1bdec___WEBPACK_IMPORTED_MODULE_0__["render"],
  _favorites_scripts_vue_vue_type_template_id_58d1bdec___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/RunScript/favorites_scripts.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/RunScript/favorites_scripts.vue?vue&type=script&lang=js&":
/*!******************************************************************************************!*\
  !*** ./resources/js/components/RunScript/favorites_scripts.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./favorites_scripts.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/RunScript/favorites_scripts.vue?vue&type=style&index=0&lang=css&":
/*!**************************************************************************************************!*\
  !*** ./resources/js/components/RunScript/favorites_scripts.vue?vue&type=style&index=0&lang=css& ***!
  \**************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader!../../../../node_modules/css-loader??ref--5-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--5-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./favorites_scripts.vue?vue&type=style&index=0&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_5_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_5_2_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./resources/js/components/RunScript/favorites_scripts.vue?vue&type=template&id=58d1bdec&":
/*!************************************************************************************************!*\
  !*** ./resources/js/components/RunScript/favorites_scripts.vue?vue&type=template&id=58d1bdec& ***!
  \************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_template_id_58d1bdec___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./favorites_scripts.vue?vue&type=template&id=58d1bdec& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/RunScript/favorites_scripts.vue?vue&type=template&id=58d1bdec&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_template_id_58d1bdec___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_favorites_scripts_vue_vue_type_template_id_58d1bdec___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
